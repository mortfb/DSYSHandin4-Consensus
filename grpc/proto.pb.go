...
func (x *TokenSend) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TokenSend) ProtoMessage() {}

func (x *TokenSend) ProtoReflect() protoreflect.Message {
	mi := &file_grpc_proto_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TokenSend.ProtoReflect.Descriptor instead.
func (*TokenSend) Descriptor() ([]byte, []int) {
	return file_grpc_proto_proto_rawDescGZIP(), []int{1}
}

func (x *TokenSend) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *TokenSend) GetToken() int32 {
	if x != nil {
		return x.Token
	}
	return 0
...
var file_grpc_proto_proto_rawDesc = []byte{
	...
	,
...
var file_grpc_proto_proto_goTypes = []interface{}{
	(*Empty)(nil),     // 0: Empty
	(*TokenSend)(nil), // 1: TokenSend
}
var file_grpc_proto_proto_depIdxs = []int32{
	1, // 0: HomeworkFourService.SendTokenToNextCLient:input_type -> TokenSend
	0, // 1: HomeworkFourService.SendTokenToNextCLient:output_type -> Empty
